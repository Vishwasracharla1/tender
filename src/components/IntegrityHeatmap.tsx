...
//             Integrity Index Heatmap
//           </h3>
//           <span className="text-xs text-gray-500">
//             {data.length} tenders tracked
//           </span>
//         </div>
//       </div>
...
//               </div>
//               {tenders.map((tender) => (
//                 <div key={tender} className="text-xs font-semibold text-gray-600 py-2 text-center">
//                   {tender}
//                 </div>
//               ))}
...
//                 <>
//                   <div key={`dept-${dept}`} className="text-sm font-medium text-gray-900 py-2 flex items-center">
//                     {dept}
//                   </div>
//                   {tenders.map((tender) => {
...
//                       <div
//                         key={`${dept}-${tender}`}
//                         className={`border rounded-lg p-3 transition-all hover:shadow-md ${getRiskColor(item.riskLevel)}`}
//                       >
